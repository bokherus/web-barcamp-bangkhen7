    ...
    return (
      <div id="resend-wrapper" className="uk-width-1-1 full-height uk-flex uk-flex-middle">
        <div className="uk-width-8-10 uk-width-medium-6-10 uk-width-large-6-10 uk-container-center uk-flex uk-flex-center uk-flex-column">
          <Header />
          <div className="uk-width-1-1 uk-text-center" style={{marginTop: "16vh"}}>
            <h3>Missing the email? Try checking your spam and trash folder before requesting a resend</h3>
            <h3>กรุณาตรวจสอบในโฟลเดอร์อีเมลขยะ หรือสแปมก่อนส่งอีเมลอีกครั้ง</h3>
          </div>
          <div className="uk-width-1-1 uk-flex uk-hidden-small">
            <div className="uk-width-8-10 email-input-wrapper">
              <div>
                <h2 className="uk-text-uppercase no-margin uk-margin-right">e-mail</h2>
              </div>
              <input ref="email" className="full-width-flex"/>
            </div>
          ...
          <h3 className="uk-text-center" style={{display: this.state.email !== null ? "" : "none"}}>E-mail has been sent to {this.state.email}</h3>
        </div>
      </div>
    );
  }
