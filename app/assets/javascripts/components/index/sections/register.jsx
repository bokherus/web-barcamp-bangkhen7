class Section extends React.Component {
  render() {
    return (
      <div className="flex flex-center uk-hidden-medium uk-hidden-large" id="description-section">
          ...
          <article className="uk-article" id="register-text">
            <div id="what-is-barcamp-wrapper">
              ...
              <div style={{
                ...
                <h1 className="uk-text-uppercase thin no-margin">WHO IS&nbsp;</h1>
                <h1 className="uk-text-uppercase no-margin barcamp">PARTICIPATING?</h1>
              ...
              <div style={{
                ...
                <h1 className="uk-text-uppercase thin no-margin">WHY SHOULD WE GO TO&nbsp;</h1>
                <h1 className="uk-text-uppercase no-margin barcamp">BARCAMP?</h1>
