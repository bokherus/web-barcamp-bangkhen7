	...
	render() {
		return (
			<div className="uk-width-1-1 event-info uk-flex uk-flex-center">
				<div className="uk-width-1-1 uk-grid uk-flex uk-flex-center uk-margin-bottom">
					<div className="uk-width-medium-3-10 uk-width-large-3-10 uk-width-small-1-1 uk-flex uk-flex-center uk-flex-middle uk-margin-bottom">
						<div className="uk-width-1-6 uk-flex uk-flex-center">
							<img className="icon" src={this.props.schedule}/>
						</div>
						<div className="index-info-text uk-margin-left uk-width-3-10 uk-width-medium-5-6 uk-width-large-4-6">
